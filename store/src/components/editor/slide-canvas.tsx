  ...
  return (
    <div
      style={{
        ...
        position: "relative",
        overflow: "hidden",
        // The banner is the store listing's header, so it should read as the
        // brand's primary surface. It was pinned to the inverted one, which on
        // a dark-first theme produced a pale banner with pale text on it.
        background: `linear-gradient(135deg, ${theme.bg} 0%, ${shade(theme.bg, -10)} 50%, ${theme.accent} 200%)`,
        display: "flex",
        alignItems: "center",
